...
<Col md={6} lg={4}>
    <Card style={{minHeight: "450px", margin:"10px",  boxShadow: '0px 2px 10px rgba(0,0,0,0.15)'}}>
        <img className="card-img-top" style={{objectFit: "cover", height: "25vh"}} src={require(`../../../assets/ecommerce/${props.file}`)} alt="Card"/>
            ...
            <ECommerceReadModal id={props.id} name={props.name} title={props.title} price={props.price} email={props.email} phone={props.phone} type={props.type} info={props.info} date={props.date} file={props.file}/>

...
import logo from '../../../assets/img/aucc_logo.jpg'
...
const Navigation = () => {
  ...
  <Navbar.Brand href="#home"><Link activeClass="active" spy={true} smooth={true} offset={-70} duration={500} to="header" activeClassName="selected"><img src={logo} style={{height: "30px", width: "30px", paddingRight: "2px"}} alt="logo"/><b style={{ fontFamily: "'Montserrat', sans-serif", color: 'blue'}}> AUCC SRC</b></Link></Navbar.Brand>
